      ...
      <div className="relative pt-8 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section id="interest-form" className="max-w-2xl mx-auto">
            <div className="bg-surface-1/50 rounded-3xl p-8 border border-surface-2">
              <h2 className="text-2xl font-bold text-white mb-2">Express Your Interest</h2>
              <p className="text-ink-400 mb-8">Tell us about yourself and how you would like to contribute.</p>

              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-ink-300 mb-2">First Name *</label>
                    <input type="text" required className="w-full px-4 py-3 bg-surface-2 border border-ink-700 rounded-xl text-white focus:outline-none focus:border-cyan-500 transition-colors" placeholder="Your first name" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-ink-300 mb-2">Last Name *</label>
                    <input type="text" required className="w-full px-4 py-3 bg-surface-2 border border-ink-700 rounded-xl text-white focus:outline-none focus:border-cyan-500 transition-colors" placeholder="Your last name" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="email" required className="w-full px-4 py-3 bg-surface-2 border border-ink-700 rounded-xl text-white focus:outline-none focus:border-cyan-500 transition-colors" placeholder="your@email.com" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-ink-300 mb-2">Phone / WhatsApp</label>
                    <input type="tel" className="w-full px-4 py-3 bg-surface-2 border border-ink-700 rounded-xl text-white focus:outline-none focus:border-cyan-500 transition-colors" placeholder="+1 (000) 000-0000" />
                  </div>
                </div>

                <div>
                  <label className="block text-sm font-medium text-ink-300 mb-2">Which cooperative interests you? *</label>
                  <select required className="w-full px-4 py-3 bg-surface-2 border border-ink-700 rounded-xl text-white focus:outline-none focus:border-cyan-500 transition-colors">
                ...
                <div>
                  <label className="block text-sm font-medium text-ink-300 mb-2">What skills or experience do you bring?</label>
                  <textarea className="w-full px-4 py-3 bg-surface-2 border border-ink-700 rounded-xl text-white focus:outline-none focus:border-cyan-500 transition-colors h-24 resize-none" placeholder="Tell us about your background, skills, and how you can contribute..." />
                </div>

                <button type="submit" className="w-full px-8 py-4 bg-cyan-500 hover:bg-cyan-400 text-surface-1 font-semibold rounded-xl transition-all">
                  Submit Interest
                </button>
                <p className="text-xs text-ink-500 text-center">We will respond within 48 hours.</p>
              </form>
            </div>
          </section>
        </div>
