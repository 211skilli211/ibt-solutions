    ...
    <div className="min-h-screen bg-slate-950">
      <CoopHero
        ...
        fallback={{
          ...
          titleGradient: 'Micro-Manufacturing',
          subtitle: 'Local micro-manufacturing of branded merchandise, print-on-demand products, and promotional materials. Sustainable practices, quick turnaround, and community-focused production.',
          ctaPrimary: { label: 'Become a Member', href: '/coops/get-involved' },
