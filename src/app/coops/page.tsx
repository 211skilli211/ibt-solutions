    ...
    <div className="min-h-screen bg-ocean-900">
      <PageHero
        ...
        fallback={{
          ...
          titleGradient: 'Democratic Ownership',
          subtitle: 'The IBT Co-operative Federation unites small businesses, skilled workers, and community members in democratically governed cooperatives. IBT Solutions serves as temporary facilitator, building infrastructure and providing tools until cooperatives can stand independently.',
          ctaPrimary: { label: 'Join WhatsApp Group', href: 'https://chat.whatsapp.com/IfkJFCpgKRn9dOLaAUzOxW' },
          ctaSecondary: { label: 'Express Interest', href: '/coops/get-involved' },
        }}
      />
      ...
      <div className="relative pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <div className="text-center p-8 rounded-2xl bg-surface-1/50 border border-surface-2">
              ...
              <p className="text-ink-400">One member, one vote. All decisions made collectively by member vote.</p>
            </div>
            <div className="text-center p-8 rounded-2xl bg-surface-1/50 border border-surface-2">
              ...
              <p className="text-ink-400">Profits distributed to members based on participation, not investment.</p>
            </div>
            <div className="text-center p-8 rounded-2xl bg-surface-1/50 border border-surface-2">
              ...
              <p className="text-ink-400">IBT Solutions provides tools, training, and infrastructure during the founding phase.</p>
            </div>
          </div>
        </div>

        <section className="py-20 border-t border-surface-2/50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {keyRoles.map((r) => (
                    <div key={r.role} className="p-4 rounded-xl bg-surface-1 border border-surface-2">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="relative p-12 rounded-3xl bg-gradient-to-br from-emerald-900/30 to-cyan-900/30 border border-emerald-500/20">
              <div className="absolute -top-6 left-1/2 -translate-x-1/2 px-6 py-2 bg-emerald-500 rounded-full shadow-lg shadow-emerald-500/20">
                <span className="text-surface-1 font-bold text-sm">Join the Movement</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  ...
                  target="_blank" 
                  className="px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-surface-1 font-semibold rounded-xl transition-all flex items-center justify-center gap-2"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl bg-surface-1/80 border border-surface-2 hover:border-emerald-500/30 transition-colors">
                ...
                <div className="p-6 rounded-2xl bg-surface-1/80 border border-surface-2 hover:border-emerald-500/30 transition-colors">
                  ...
                  <div className="p-4 rounded-xl bg-cyan-500/5 border border-cyan-500/20">
                    ...
                    <p className="text-ink-500 text-xs mt-2">— IBT Solutions Cooperative Development Team</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-20">
              ...
              <p className="text-ink-400 max-w-3xl mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="p-6 rounded-2xl bg-gradient-to-b from-amber-900/20 to-surface-1 border border-amber-500/20 hover:border-amber-500/40 transition-colors">
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-b from-emerald-900/20 to-surface-1 border border-emerald-500/20 hover:border-emerald-500/40 transition-colors">
                ...
                <div className="p-6 rounded-2xl bg-gradient-to-b from-cyan-900/20 to-surface-1 border border-cyan-500/20 hover:border-cyan-500/40 transition-colors">
            ...
            <div className="mb-20">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="p-5 rounded-2xl bg-surface-1/80 border border-surface-2 text-center">
                  <span className="text-3xl mb-3 block">🧂</span>
                  <h4 className="font-bold text-white text-sm mb-1">Sea Moss & Salt</h4>
                  <p className="text-ink-500 text-xs">Frigate Bay salt ponds and sea moss cultivation as coop products</p>
                </div>
                <div className="p-5 rounded-2xl bg-surface-1/80 border border-surface-2 text-center">
                  <span className="text-3xl mb-3 block">🎭</span>
                  <h4 className="font-bold text-white text-sm mb-1">Carnival Economy</h4>
                  <p className="text-ink-500 text-xs">Event services, costumes, and hospitality through co-op structures</p>
                </div>
                <div className="p-5 rounded-2xl bg-surface-1/80 border border-surface-2 text-center">
                  <span className="text-3xl mb-3 block">⛰️</span>
                  <h4 className="font-bold text-white text-sm mb-1">Mt. Liamuiga</h4>
                  <p className="text-ink-500 text-xs">Tours, farming, and eco-tourism cooperatives serving the mountain region</p>
                </div>
                <div className="p-5 rounded-2xl bg-surface-1/80 border border-surface-2 text-center">
                  <span className="text-3xl mb-3 block">⚓</span>
                  <h4 className="font-bold text-white text-sm mb-1">Frigate Bay</h4>
                  <p className="text-ink-500 text-xs">Marine charters, watersports, and coastal commerce cooperatives</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-20">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className={`flex items-start gap-4 p-5 rounded-2xl border transition-colors ${item.active ? 'bg-emerald-500/5 border-emerald-500/30' : 'bg-surface-1/50 border-surface-2'}`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${item.active ? 'bg-emerald-500 text-white' : 'bg-surface-2 text-ink-300'}`}>
                      {item.active ? '✓' : i + 1}
                    </div>
                    <div>
                      <h4 className={`font-bold ${item.active ? 'text-emerald-400' : 'text-white'}`}>{item.phase}</h4>
                      <p className="text-ink-400 text-sm mt-1">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-20">
              {[
                ...
                <div key={i} className="text-center p-6 rounded-2xl bg-surface-1/80 border border-surface-2">
                  ...
                  <div className="text-[10px] text-ink-500 uppercase tracking-wider">{stat.sub}</div>
                </div>
              ))}
            </div>
          </div>
