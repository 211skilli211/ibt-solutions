  ...
  return (
    <div className="bg-slate-950 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link href="#contact" className="px-4 py-2 bg-cyan-500 hover:bg-cyan-400 text-slate-900 text-sm font-medium rounded-lg transition-colors">Join</Link>
            </div>
          </div>
        </div>
      </nav>
            ...
            <div className="relative">
              ...
              <div className="relative bg-slate-900 rounded-3xl p-8 border border-slate-800">
                <div className="text-center mb-8">
                  <div className="text-6xl font-bold bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent mb-2">500+</div>
                  <div className="text-slate-400">Estimated Members by Year 2</div>
                </div>
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white">5</div>
                    <div className="text-sm text-slate-500">Co-ops in Phase 1</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white">100%</div>
                    <div className="text-sm text-slate-500">Member Ownership</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-white">0%</div>
                    <div className="text-sm text-slate-500">External Investors</div>
                  </div>
                  <div className="text-center">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">Key Roles We Need</h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
              Each cooperative needs dedicated members to fill leadership and operational roles.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {keyRoles.map((role) => (
              <div key={role.role} className="p-6 rounded-2xl bg-slate-900 border border-slate-800">
                <div className="text-3xl font-bold text-cyan-400 mb-2">{role.count}</div>
          ...
          <div className="text-center mt-12">
            <Link href="/coops/get-involved" className="inline-flex items-center gap-2 px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-semibold rounded-xl transition-all">
      ...
      <section className="py-20 bg-gradient-to-b from-slate-950 to-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">How the Federation Works</h2>
          <p className="text-slate-400 mb-8">
            Learn about our democratic structure, profit-sharing model, and how IBT Solutions 
            facilitates growth until cooperatives are self-sufficient.
          </p>
          <Link href="/coops/how-it-works" className="inline-flex items-center gap-2 px-6 py-3 border border-slate-700 hover:border-slate-600 text-white font-medium rounded-xl transition-all">
      ...
      <section id="contact" className="py-20 border-t border-slate-800">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 mb-8">
            Connect with us on WhatsApp or submit your interest form to become a founding member.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://chat.whatsapp.com/example" target="_blank" className="px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-semibold rounded-xl transition-all flex items-center justify-center gap-2">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <a href="https://islandhub.app" target="_blank" className="text-sm text-slate-400 hover:text-white transition-colors">IslandHub</a>
            </div>
