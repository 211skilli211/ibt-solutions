    ...
    <div className="min-h-screen bg-slate-950">
          ...
          <div className="bg-slate-900 rounded-3xl p-8 border border-slate-800">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-amber-500 flex items-center justify-center text-slate-900 font-bold flex-shrink-0">1</div>
                <div>
                  <h3 className="font-semibold text-white mb-1">Order Placement</h3>
                  <p className="text-slate-400 text-sm">Members and IslandHub vendors submit delivery requests through the platform.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-amber-500 flex items-center justify-center text-slate-900 font-bold flex-shrink-0">2</div>
                <div>
                  <h3 className="font-semibold text-white mb-1">Route Consolidation</h3>
                  <p className="text-slate-400 text-sm">Orders heading to the same area are grouped for efficient delivery runs.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-amber-500 flex items-center justify-center text-slate-900 font-bold flex-shrink-0">3</div>
                <div>
                  <h3 className="font-semibold text-white mb-1">Pickup & Delivery</h3>
                  <p className="text-slate-400 text-sm">Co-op drivers handle pickup from vendors and delivery to customers or retail points.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">Transparent pricing with per-delivery billing deducted from member earnings.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 border-t border-slate-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-400 mb-8">Whether you need delivery services or want to be a driver — there is a place for you.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/coops/get-involved" className="px-8 py-4 bg-amber-500 hover:bg-amber-400 text-slate-900 font-semibold rounded-xl transition-all">
              Express Interest
            </Link>
