...
const moreServices = [
  { title: 'AI Marketing', desc: 'Generative AI for product photos, ad videos, branded content, virality scoring.', href: '/services/ai/marketing' },
  { title: 'AI Hedge Fund', desc: 'Multi-agent investment analysis modeled after legendary investors.', href: '/services/ai/hedge-fund' },
