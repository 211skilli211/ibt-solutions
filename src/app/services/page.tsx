...
const services = [
  ...
  { id: 'ai-marketing', title: 'AI Marketing', description: 'Generative AI for product photos, ad videos, branded content, and virality analysis.', icon: '📢', image: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=600&h=400&fit=crop', href: '/services/ai/marketing', category: 'ai', features: ['Product Photoshoot AI', 'Video Ad Generation', 'Marketing Studio', 'Virality Predictor'], whiteLabel: true },
  { id: 'ai-hedge-fund', title: 'AI Hedge Fund', description: 'Multi-agent investment analysis modeled after legendary investors — Buffett, Munger, Graham, Taleb.', icon: '📊', image: 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=600&h=400&fit=crop', href: '/services/ai/hedge-fund', category: 'ai', features: ['12+ AI Agents', 'Fundamental Analysis', 'Risk Management', 'Macro Intelligence'], whiteLabel: false },
  ...
  { id: '3d-design', title: '3D Design Tools', description: 'Text-to-CAD generation — describe any 3D object and get a parametric model. Browser-based, no installation.', icon: '🧊', image: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=600&h=400&fit=crop', href: '/services/3d-design', category: 'ai', features: ['Text-to-CAD', 'Image-to-CAD', 'Parametric Editing', 'STL Export'], whiteLabel: false },
