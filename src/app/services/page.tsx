...
const services: Service[] = [
  ...
  },
  {
    ...
    description: 'Unlimited trained agents for your business — flat $5K/mo. Revenue-focused, not time-saving. 48-hour deployment.',
    icon: '🤖',
    ...
    href: '/services/ai',
    category: 'ai',
    features: ['Unlimited agents', 'Unlimited usage', 'Unlimited support', '48hr deployment'],
    whiteLabel: true,
  },
  {
    id: 'ai-marketing',
